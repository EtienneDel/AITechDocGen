...
exports.mockModifiedFileContent = exports.mockFileContent = exports.mockFunctionInfos = exports.indentedDoc = exports.doc2 = exports.doc = exports.mockContext = exports.mockGetInputs = exports.getMockOctokit = void 0;
const getMockOctokit = ({ listFilesMock, getContentMock, createOrUpdateFileContentsMock, } = {}) => ({
    rest: {
        pulls: {
            listFiles: jest.fn().mockResolvedValue(listFilesMock !== null && listFilesMock !== void 0 ? listFilesMock : {
                data: [
        ...
        repos: {
            getContent: jest.fn().mockResolvedValue(getContentMock !== null && getContentMock !== void 0 ? getContentMock : {
                data: {
                    type: "file",
            ...
            createOrUpdateFileContents: createOrUpdateFileContentsMock !== null && createOrUpdateFileContentsMock !== void 0 ? createOrUpdateFileContentsMock : jest.fn().mockResolvedValue(true),
        },
    },
});
...
exports.mockGetInputs = mockGetInputs;
exports.mockContext = {
    repo: {
        owner: "testOwner",
        repo: "testRepo",
